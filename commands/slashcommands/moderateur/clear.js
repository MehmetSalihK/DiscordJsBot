  ...
  async execute(interaction) {
    try {
      if (!interaction.memberPermissions?.has(PermissionsBitField.Flags.ManageMessages)) {
        return interaction.reply({ embeds: [createErrorEmbed('Permission manquante', "Vous n'avez pas la permission de gérer les messages.")], ephemeral: true });
      }
      if (!interaction.guild.members.me.permissions.has(PermissionsBitField.Flags.ManageMessages)) {
        return interaction.reply({ embeds: [createErrorEmbed('Permission manquante', "Je n'ai pas la permission de gérer les messages.")], ephemeral: true });
      }
      ...
      return interaction.reply({ embeds: [createErrorEmbed('Erreur', 'Une erreur est survenue lors de la suppression des messages.')], ephemeral: true });
    }
  },
};
