...
export default {
  ...
  async execute(interaction, client) {
    try {
      ...
      await interaction.reply({ embeds: [init.embed], components: init.components, ephemeral: true });
    } catch (error) {
      ...
      return interaction.reply({ content: "Une erreur est survenue lors de l'affichage de l'aide.", ephemeral: true });
    }
  },
};
